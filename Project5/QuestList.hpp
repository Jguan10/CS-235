...
Description:
QuestList.hpp declares the QuestList class along with its public member functions
...
public:
    ...
    */
    QuestList(const std::string& file_name);
    ...
    */
    bool addQuest(const std::string& title, const std::string& descript, const bool& completed, const int& exp_points, const std::vector<Quest*>& dependencies, const std::vector<Quest*>& subquests);
